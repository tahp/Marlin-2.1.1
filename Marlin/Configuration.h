...
#define STRING_CONFIG_H_AUTHOR "(beta, pugs)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Delta Variant"
 ...
 */
#define PSU_CONTROL
//#define PSU_NAME "xBox Power Supply"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Use separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  129.22,  129.22 }
    #define DEFAULT_Ki_LIST {   9.17,   9.17 }
    #define DEFAULT_Kd_LIST { 455.16, 455.16 }
  #else
...
#define DELTA
  ...
  #define DELTA_HEIGHT 210.6             // (mm) Get this value from G33 auto calibrate

  #define DELTA_ENDSTOP_ADJ { 0.0, 0.0, 0.0 } // Get these values from G33 auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 85.0              // (mm) Get this value from G33 auto calibrate
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 150, 150, 150, 800 }
